...
filename = 'addresses.txt' #insert filename to read addresses from
...
for i in range(len(address)):
    payload = {'module': 'account', 'action': 'txlist', 'address': address[i], 'apikey': 'SPNQSIYV63N2DP53DMCK1RGVUKF9Q2ENXV'}  
